function [ output_Ref ] = OptForwardAKDerZP( InParam, wavelet, cutoffAngle, theta, avgVel ,Flag)
...
if Flag == 1
    ...
    %apply wavelet
    output_Ref = multiTraceConvZP( mutedTrace, numOffsets, wavelet, Flag );
end

if Flag == -1
    %Deconvolute trace
    outTrace = multiTraceConvZP( InParam, numOffsets, wavelet, Flag );
