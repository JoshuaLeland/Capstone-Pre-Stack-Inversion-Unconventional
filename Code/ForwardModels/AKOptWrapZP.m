function [ OUT ] = AKOptWrapZP(IN, PARAM, flag )
...
if flag == 1
    ...
    OUT = OptForwardAKDerZP( InParam, wavelet, cutoffAngle, theta, avgVel ,flag);
...
if flag == -1
    ...
    %Transpose operation
    outParam = OptForwardAKDerZP( IN, wavelet, cutoffAngle, theta, avgVel ,flag);
